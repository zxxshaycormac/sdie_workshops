# actions-run-status-aggregation Specification

## Purpose

Define how Gitea Actions workflow runs derive their visible run status from job
statuses and which run statuses are filterable on the repository Actions page.
